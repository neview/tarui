...
function SplashCursor({
  ...
  useEffect(() => {
    ...
    function getWebGLContext(cvs: HTMLCanvasElement) {
      ...
      let glCtx = cvs.getContext('webgl2', params) as any;
      const isWebGL2 = !!glCtx;
      if (!isWebGL2) glCtx = cvs.getContext('webgl', params) || cvs.getContext('experimental-webgl', params);
    ...
    function updatePointerMoveData(pointer: PointerData, posX: number, posY: number, color: { r: number; g: number; b: number }) {
      pointer.prevTexcoordX = pointer.texcoordX;
      pointer.prevTexcoordY = pointer.texcoordY;
      pointer.texcoordX = posX / canvas.width;
      pointer.texcoordY = 1.0 - posY / canvas.height;
